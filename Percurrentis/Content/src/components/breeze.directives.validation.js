        ...
        function link(scope, element, attrs) {
            ...
            function linkForInput() {
                ...
                element.on('blur', function () {
                    ...
                    element.parent().addClass('has-visited');
                });
    ...
    */
    module.provider('zDirectivesConfig', function () {
        ...
        this.zValidateTemplate =
            '<span class="help-block text-warning validation-error">%error%</span>';
        ...
        this.zRequiredTemplate =
            '<span class="gi gi-asterisk text-muted form-control-feedback" title="Required"></span>';
